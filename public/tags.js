...
riot.tag2('app', '<div if="{!this.audit}">Loading... hold on...</div> <div if="{this.audit}"> <h1>Score: {this.analysis.points}</h1> </div> <entry each="{entry in this.audit}" data="{entry}"></entry>', '', '', function (opts) {
  var _this = this;
